...
$role_check_query = "SELECT role, specialization FROM users WHERE id = '$user_id'";
$role_result = $conn->query($role_check_query);
if ($role_result->num_rows > 0) {
    $user_data = $role_result->fetch_assoc();
    $user_role = $user_data['role'];
    $specialization = $user_data['specialization'] ?? 'Not specified';
...
function updateProfile($conn, $user_id) {
    ...
    // FIXED: Removed specialization from update since trainers can't edit it
...
<head>
    ...
    <title>Trainer Profile - Management System</title>
            ...
            <div class="max-w-5xl">
                ...
                <div id="profile-content" class="center-content">
                    ...
                    <div class="profile-header">
                        <div class="profile-main">
                            <div class="profile-identity">
                                <!-- Fullname (BOLD and PROMINENT) -->
                                <p class="profile-fullname"><?php echo displayData($user['fullname']); ?></p>
                                
                                <!-- Email -->
                                <p class="profile-email">
                                    <i class="fas fa-envelope"></i> <?php echo displayData($user['email']); ?>
                                </p>
                                
                                <div class="profile-badge-container">
                                    <span class="profile-badge" style="background: linear-gradient(135deg, #4A90E2, #357ABD);">
                                        <i class="fas fa-user-tie"></i> <?php echo $role_display; ?>
                                    </span>
                                </div>
                    ...
                    <div class="personal-info">
                        <h3><i class="fas fa-user-tie"></i> Trainer Profile</h3>
                        ...
                        <div id="view-mode">
                            ...
                            <div class="centered-info-section">
                                ...
                                <div class="centered-info-item">
                                    <b><i class="fas fa-graduation-cap"></i> Specialization</b>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-grid">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="specialization" value="<?php echo htmlspecialchars($specialization); ?>" 
